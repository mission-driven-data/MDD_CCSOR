...
IF OBJECT_ID (N'dbo._mdd_SmartDate') IS NOT NULL
DROP TABLE dbo._mdd_SmartDate
...
SELECT * into dbo._mdd_SmartDate FROM dim
  ORDER BY TheDate
  ...
  CREATE UNIQUE CLUSTERED INDEX PK_mdd_DateDimension ON dbo._mdd_SmartDate(TheDate);
